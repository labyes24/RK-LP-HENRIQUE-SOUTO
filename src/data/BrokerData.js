...
const brokerProfileES = {
  ...
  description: {
    title:
      '"Soy un inversor especializado en el mercado financiero e inmobiliario."',
    paragraph: [
      'Trabajo en el mercado inmobiliario en Florianópolis desde 2018, tengo experiencia en el mercado inmobiliario desde hace aproximadamente 10 años.',
      'Conozco las necesidades de mis clientes y siempre les brindo la mejor experiencia en cuanto a inversiones inmobiliarias, ya sea para residencia o para obtener rentabilidad.',
      '¡Habla conmigo y asegúrate de que tu sueño se haga realidad!',
    ],
  },
  address: {
    street: 'Rua das Gaivotas',
